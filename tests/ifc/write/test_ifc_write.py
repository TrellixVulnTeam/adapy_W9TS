...
def test_export_basic(ifc_test_dir):
    ...
    bm1 = Beam("bm1", n1=[0, 0, 0], n2=[2, 0, 0], section="IPE220", colour="red")
    bm2 = Beam("bm2", n1=[0, 0, 0], n2=[0, 2, 0], section="IPE220", colour="blue")
    bm3 = Beam("bm3", n1=[0, 0, 0], n2=[0, 0, 2], section="IPE220", colour="green")
    bm4 = Beam("bm4", n1=[0, 0, 0], n2=[2, 0, 2], section="IPE220", colour="black")
    bm5 = Beam("bm5", n1=[0, 0, 2], n2=[2, 0, 2], section="IPE220", colour="white")
...
def test_ifc_groups(ifc_test_dir):
    ...
    p.add_beam(Beam("bm1", n1=[0, 0, 0], n2=[2, 0, 0], section="IPE220", colour="red"))
    a.add_part(p)
    ...
    newp.add_beam(Beam("bm2", n1=[0, 0, 0], n2=[0, 2, 0], section="IPE220", colour="blue"))
    p.add_part(newp)
    ...
    newp2.add_beam(Beam("bm3", n1=[0, 0, 0], n2=[0, 0, 2], section="IPE220", colour="green"))
    newp2.add_plate(
        Plate(
            "pl1",
            [(0, 0, 0), (0, 0, 2), (0, 2, 2), (0, 2.0, 0.0)],
...
def test_profiles_to_ifc(ifc_test_dir):
    ...
    p = Part("MyPart")
    p.add_beam(Beam("bm1", n1=[0, 0, 0], n2=[2, 0, 0], section="IPE220", colour="red"))
    p.add_beam(Beam("bm2", n1=[0, 0, 1], n2=[2, 0, 1], section="HP220x10", colour="blue"))
    p.add_beam(Beam("bm3", n1=[0, 0, 2], n2=[2, 0, 2], section="BG800x400x20x40", colour="green"))
    p.add_beam(Beam("bm4", n1=[0, 0, 3], n2=[2, 0, 3], section="CIRC200", colour="green"))
    p.add_beam(Beam("bm5", n1=[0, 0, 4], n2=[2, 0, 4], section="TUB200x10", colour="green"))
    a.add_part(p)
